            ...
            <div id="kt_app_header" class="app-header ">
                ...
                <div class="app-container  container-xxl d-flex align-items-stretch justify-content-between  "
                    ...
                    <div class="d-flex align-items-center  flex-lg-grow-0 me-lg-0">
                        <a href="/home">
                            <!--<img alt="Logo"-->
                            <!--    src="/admin/assets/media/misc/S.png"-->
    ...
    " data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}"
        ...
        " id="kt_app_header_menu" data-kt-menu="true">
                                                ...
                                                <div class="col-lg-6 py-1">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        ...
                                                        <a href="../dashboards/ecommerce.html" class="menu-link ">
                                                            <span
                                                                class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                                <i class="ki-duotone ki-element-11 text-danger fs-1"><span
                                                                        class="path1"></span><span
                                                                        class="path2"></span><span
                                                                        class="path3"></span><span
                                                                        class="path4"></span></i> </span>
                                                ...
                                                <div class="col-lg-6 py-1">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        ...
                                                        <a href="../dashboards/social.html" class="menu-link ">
                                                            <span
                                                                class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                                <i class="ki-duotone ki-abstract-39 text-success fs-1"><span
                                                                        class="path1"></span><span
                                                                        class="path2"></span></i> </span>
                                                ...
                                                <div class="tab-pane  w-lg-600px"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-6">
                                                                <!--begin:Menu heading-->
                                                                <h4 class="fs-6 fs-lg-4 fw-semibold mb-3 ms-4">Corporate
                                                                </h4>
                                                                <!--end:Menu heading-->
                                ...
                                {{-- <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    data-kt-menu-placement="bottom-end" class="menu-item here show  here show">
                                    <!--begin:Menu link--><span class="menu-link"><span
                                        ...
                                        <div class="menu-state-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7 mb-3 pt-2 pe-lg-8">
                                                    <img src="{{asset('admin')}}/assets/media/stock/900x600/74.jpg"
                                                        class="rounded mw-100" alt="" />
                                                </div>
                                                <!--end:Col-->
                                            </div>
                                        ...
                                        <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                ...
                                                target="_blank"><span class="menu-icon"><i
                                                        class="ki-duotone ki-code fs-2"><span class="path1"></span><span
                                                            ...
                                                            class="path4"></span></i></span><span
                                                    class="menu-title">Changelog v3.0.7</span></a><!--end:Menu link-->
                                        </div><!--end:Menu item-->
                                    </div><!--end:Menu sub-->
                                </div><!--end:Menu item--> --}}
                            </div>
                                                ...
                                                <div class="scroll-y mh-200px mh-lg-350px">
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/svg/brand-logos/volicity-9.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/svg/brand-logos/tvit.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/svg/misc/infography.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/svg/brand-logos/leaf.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/svg/brand-logos/tower.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                            ...
                            {{-- <div class="app-navbar-item ms-1 ms-lg-3">
                                ...
                                <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                                    ...
                                    <span class="symbol symbol-20px">
                                        <img class="rounded"
                                            src="https://preview.keenthemes.com/keen/demo1/assets/media/flags/united-states.svg"
                                            alt="" />
                                    </span>
                                </div>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-175px"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/flags/spain.svg"
                                                    alt="" />
                                            </span>
                                            Spanish
                                        </a>
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/flags/germany.svg"
                                                    alt="" />
                                            </span>
                                            German
                                        </a>
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/flags/japan.svg"
                                                    alt="" />
                                            </span>
                                            Japanese
                                        </a>
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="../account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="https://preview.keenthemes.com/keen/demo1/assets/media/flags/france.svg"
                                                    alt="" />
                                            </span>
                                            French
                                        </a>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="{{ route('locale', ['locale' => 'hb']) }}"
                                class="menu-link px-3 py-2 {{ Session::get('locale') == 'hb' ? 'active' : '' }}">
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="{{ route('locale', ['locale' => 'en']) }}"
                                class="menu-link px-3 py-2 {{ Session::get('locale') == 'en' ? 'active' : '' }}">
                                <span class="menu-icon">
                                    <i class="fa-solid fa-language"></i> </span>
                                <span class="menu-title">
                                English
