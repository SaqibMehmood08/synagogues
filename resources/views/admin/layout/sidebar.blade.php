                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold" id="#kt_app_sidebar_menu"
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!-- begin:Menu link -->
                                <a class="menu-link " id="menu-link-home" href="{{ route('home') }}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">{{__('Default')}}</span></a>
                                <!-- end:Menu link -->
                            </div>
                            <!-- end:Menu item -->
                            @role('administrator')
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
        ...
        var appSidebar = document.getElementById('kt_app_sidebar');
