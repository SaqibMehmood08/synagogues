...
@section('content')
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('prayer-sub-category.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <select class="form-select" name="prayer_category_id" aria-label="Default select example" required>
                            <option selected>{{__('Select')}} {{__('Category')}}</option>
    ...
    <script>
        function confirmDelete(event) {
            ...
            const isConfirmed = confirm('Do you want to delete this Sub Category?');
            if (isConfirmed) {
