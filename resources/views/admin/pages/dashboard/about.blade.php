...
@section('content')
            ...
            <div class="modal-content">
                ...
                <form class="" method="POST" action="{{ route('about.store') }}">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <textarea class="form-control" name="content" placeholder="{{__('Enter Content')}} " rows="3"></textarea>

                        </div>
                        <div class="mb-3">
                            <textarea class="form-control" name="subtitle" placeholder="{{__('Enter Subtitle')}} " rows="3"></textarea>
    ...
    <script>
        function confirmDelete(event) {
            ...
            const isConfirmed = confirm('Do you want to delete this About content?');
