...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editCityForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="TodayTime" class="form-label">{{__('Time')}}</label>
                            <input type="time" class="form-control" id="TodayTime" name="time" >
                        </div>
                        <div class="mb-3">
    ...
    <script>
        function confirmDelete(event) {
            ...
            const isConfirmed = confirm('Do you want to delete this Time?');
