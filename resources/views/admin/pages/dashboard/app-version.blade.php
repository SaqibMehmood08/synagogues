...
@section('content')
    <div class="container px-10 mt-4">
        <div class="row mt-4">
            <strong class="text-danger">{{__('Only one version is required. For the new version, update this one.')}}</strong>
    ...
    <script>
        function confirmDelete(event) {
            ...
            const isConfirmed = confirm('Do you want to delete this App version?');
